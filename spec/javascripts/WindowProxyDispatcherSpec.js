...
function() {
	...
	function() {
		...
		'param=value&message&sourceOrigin=http%3A//localhost%3A8888&targetOrigin=*&sourceWindowName=a&targetWindowName=b'
		)).toEqual(
		{
			targetOrigin: '*',
