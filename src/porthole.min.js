...
a.targetOrigin):d.error("Could not find window proxy object on the target window")}},findWindowProxyObjectInWindow:function(a,c){var b;if(a){alert(a.Porthole.WindowProxy);alert(a.window.Porthole.WindowProxy);for(b in a)if(Object.prototype.hasOwnProperty.call(a,b))try{if(a[b]!==null&&typeof a[b]==="object"&&a[b]instanceof a.Porthole.WindowProxy&&a[b].getTargetWindowName()===c)return a[b]}catch(d){}}return null},start:function(){b.addEventListener?b.addEventListener("resize",d.WindowProxyDispatcher.forwardMessageEvent,
false):b.attachEvent&&b.postMessage!=="undefined"?b.attachEvent("onresize",d.WindowProxyDispatcher.forwardMessageEvent):document.body.attachEvent?b.attachEvent("onresize",d.WindowProxyDispatcher.forwardMessageEvent):d.error("Cannot attach resize event")}};"undefined"!==typeof b.exports?b.exports.Porthole=d:b.Porthole=d})(this);
